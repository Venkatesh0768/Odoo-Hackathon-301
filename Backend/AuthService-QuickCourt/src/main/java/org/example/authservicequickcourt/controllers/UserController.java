...
import org.example.authservicequickcourt.dtos.*;
import org.example.authservicequickcourt.models.OtpRequest;
import org.example.authservicequickcourt.models.OtpVerificationRequest;
...
@CrossOrigin(origins = {"http://localhost:5173", "http://localhost:3000", "https://e286598e46f4.ngrok-free.app"}, allowCredentials = "true")
@Slf4j
public class UserController {
    ...
    @PostMapping("/signup")
    public ResponseEntity<ApiResponseDto<User>> signup(@RequestBody UserRequestDto user) {
        try {
